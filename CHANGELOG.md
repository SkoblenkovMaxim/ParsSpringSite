...
в названия сервисов  добавить окончание Impl (implementation) и реализовать их от интерфейсов - 02.12.2023
----------------------------------------
+ в enum нужно сделать метод который по строке будет искать константу  - 06.12.2023
