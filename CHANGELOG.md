...
==============================
23.11.2023
- 1. контроллер должен отдавать список голосований
- 2. надо уточнить немного, голосование у нас это объект poll, поправь чтобы объекты возвращались

=============================
- часть кода которая идет на сайт берет документ нужно вынести в MkService
- MkService заинжектить в ParSiteSrvice
- и в ParSiteSrvice брать документ из MkService
- по типу как инжектили сервис в контроллер

===========================
+ -перенести логику из application в сервис
+ распечатку в консоль убрать
+ -ParSiteData надо переименовать в Poll
+ -контроллер должен отдавать список голосований
+ -урл перенести в настройки
----------------------------------------
