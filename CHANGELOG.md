...
- названия пакетов CaptainPiston.ParsSpringSite с маленькой буквы надо сделать
...
----------------------------------------
+ после переноса логики в сервис парсинга -   - 29.11.2023
  нужно создать еще один сервис МкService
  и вынести туда логику jsoup запроса документа
  +затем МкService заинжектить в сервис парсинга  - 29.11.2023
